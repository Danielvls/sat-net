...
csv_cost_filename = 'result/summary_total_cost_1.csv'
csv_usage_filename = 'result/summary_link_usage_1.csv'
csv_blocked_rate_filename = 'result/summary_blocked_rate_1.csv'
...
plt.legend()
plt.grid(True)
plt.savefig('result/total_cost_vs_avg_flow_num_1.png')
plt.show()
...
plt.legend()
plt.grid(True)
plt.savefig('result/link_usage_vs_avg_flow_num_1.png')
plt.show()
...
plt.legend()
plt.grid(True)
plt.savefig('result/blocked_rate_vs_avg_flow_num_1.png')
plt.show()