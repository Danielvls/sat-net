...
for orbitPlaneNum, RAAN in enumerate(
    ...
    for satNum, trueAnomaly in enumerate(
        ...
        sat_lla = []
        chainDataProvider = satellite.DataProviders.GetDataPrvTimeVarFromPath("LLA State/TrueOfDateRotating")
